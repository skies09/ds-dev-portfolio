...
export default function Menu({ menuOpen, setMenuOpen }) {
  console.log(menuOpen,'menu open menu')
  return (
    <div className={`${menuOpen ? 'w-1/2 md:w-1/5 h-screen bg-colorOne fixed top-0 -right-4 z-20 flex flex-col items-center justify-center':'hidden'}`}>
      <ul>
        <li onClick={()=>setMenuOpen(false)}>
