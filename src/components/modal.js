...
export default function PortfolioModal({ project, onClose }) {
	return (
		...
		>
			<motion.div
				className="flex flex-col justify-center bg-colorTwo p-3 text-colorFive border border-colorFive rounded-xl w-5/6 md:w-1/2 xl:w-1/3 relative shadow-shadow-colorTwo"
				onClick={(e) => e.stopPropagation()}
			>
				<p className="text-2xl text-colorFive font-bold flex justify-center text-center font-sans py-4 tracking-widest">
					{project.title}
				</p>
